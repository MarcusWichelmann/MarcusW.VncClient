...
namespace MarcusW.VncClient
{
    ...
    public class VncClient
    {
        ...
        public async Task<VncConnection> ConnectAsync(IAuthenticationHandler authenticationHandler,
            IRenderTarget renderTarget, CancellationToken cancellationToken = default)
        {
            var vncConnection =
                new VncConnection(_loggerFactory, _supportedEncodings, authenticationHandler, renderTarget);
